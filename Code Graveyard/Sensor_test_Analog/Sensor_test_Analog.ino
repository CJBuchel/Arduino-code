...
#include <RedBot.h>
RedBotSensor IRSensor1 = RedBotSensor(A5); // initialize a sensor object on A3
RedBotSensor IRSensor2 = RedBotSensor(A4); // initialize a sensor object on A6
RedBotSensor IRSensor3 = RedBotSensor(A0); // initialize a sensor object on A7
